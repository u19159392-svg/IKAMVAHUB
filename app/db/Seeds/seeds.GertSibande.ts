...
export const GERT_SIBANDE_COURSES = [
...

  {
    ...
    apply_url: "https://www.gscollege.co.za",
  },
...

  {
    ...
    life_sciences: null,
    nbt: null,
    additional_requirements: "Grade 12 with Mathematics & Physical Sciences or N3.",
    apply_url: "https://www.gscollege.co.za",
  },
  ...
  {
    faculty: "Engineering Studies",
    qualification: "Industrial Electronics N4–N6",
    qualification_type: "NATED (Report 191)",
    duration: "18 Months",
    minimum_aps: null,
    fps: null,
    ...
    life_sciences: null,
    nbt: null,
    additional_requirements: "Relevant N3 or Grade 12.",
    apply_url: "https://www.gscollege.co.za",
  },

  {
    faculty: "Engineering Studies",
    qualification: "Mechanical Draughting N4",
    qualification_type: "NATED (Report 191)",
...

  {
    ...
    life_sciences: null,
    nbt: null,
    additional_requirements: "Grade 9 or higher. National Certificate (Vocational) Level 2–4.",
    apply_url: "https://www.gscollege.co.za",
  },
...

  {
    ...
    life_sciences: null,
    nbt: null,
    additional_requirements: "Apprenticeship / artisan development programme.",
    apply_url: "https://www.gscollege.co.za",
  },
...

  {
    ...
    life_sciences: null,
    nbt: null,
    additional_requirements: "Short course requirements not specified in the provided information.",
    apply_url: "https://www.gscollege.co.za",
  },
];
...
// ======================================================
// SEED GERT SIBANDE TVET COLLEGE
// ======================================================

export const seedGertSibande = async (
  ...
  if (!college) {
    throw new Error("Gert Sibande TVET College not found.");
  }
const institutionId = college.id;

for (const course of GERT_SIBANDE_COURSES) {
  ...
  await db.runAsync(
    ...
    [
      ...
      course.fps ?? null,
      course.english_hl ?? null,
      course.english_fal ?? null,
      course.mathematics ?? null,
      course.mathematical_literacy ?? null,
      course.physical_sciences ?? null,
      course.life_sciences ?? null,
      course.nbt ?? null,
      course.additional_requirements ?? null,
      course.apply_url ?? null,
    ],
  );
}

console.log(
  `Gert Sibande TVET College seeded: ${GERT_SIBANDE_COURSES.length} programmes.`,
);
};